...
This project was developed as part of the Postgraduate Diploma in ICT (Software Engineering) at **Cape Peninsula University of Technology (CPUT)**. It demonstrates core web development skills, version control practices, and an understanding of password security principles relevant to cybersecurity.
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/Mbasa6/password-strength-checker.git
   ```
...
│   ├── screenshot-strong1.png
│   ├── screenshot-strong2.png
│   ├── screenshot-weak1.png
│   └── screenshot-weak2.png
...
![Password Strength Checker - Weak A](screenshots/screenshot-weak1.png)
![Password Strength Checker - Weak B](screenshots/screenshot-weak2.png)
![Password Strength Checker - Strong A](screenshots/screenshot-strong1.png)
![Password Strength Checker - Strong B](screenshots/screenshot-strong2.png)
...
**Mbasa Avuyile Cabane - 221307311**
